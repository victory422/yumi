...
public class AnnounceRepositoryCustom {
	...
	// 목록 조회
	public List<AdminResponseDto> findAll(AnnounceRequestDto dto) {
	...
	public List<AdminResponseDto> findAllWidhoutName(AnnounceRequestDto dto) {
		return jpaQueryFactory
				.select(Projections.constructor(AdminResponseDto.class
						, admin.admin_id.as("adminId")
						, admin.name
	...
	// 정보 수정
	public void updateAdmin(AnnounceRequestDto dto) {
	...
	public List<Tuple> findAdminDetailList(AnnounceRequestDto dto) {
		return jpaQueryFactory
				.select(
	...
	public void deleteAnnounceById(String string, String loginId) {
