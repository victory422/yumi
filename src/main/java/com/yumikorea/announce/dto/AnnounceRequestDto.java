...
public class AnnounceRequestDto extends BasicRequestDto {
	...
	@Builder
	public AnnounceRequestDto( String adminId, String name, String password, String email, Date regDate, Date modDate, 
...
//		}
	...
	public AnnounceRequestDto toUpdateEntity() {
...
//		}
		...
		return AnnounceRequestDto.builder()
				.adminId( adminId )
				.name( name )
