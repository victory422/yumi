...
public class DBRequestDto extends BasicRequestDto {
	...
	@Builder
	public DBRequestDto( String adminId, String name, String password, String email, Date regDate, Date modDate, 
...
//		}
	...
	public DBRequestDto toUpdateEntity() {
