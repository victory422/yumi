...
public class DBRepositoryCustom {
	...
	// 목록 조회
	public List<AdminResponseDto> findAll(DBRequestDto dto) {
	...
	public List<AdminResponseDto> findAllWidhoutName(DBRequestDto dto) {
		return jpaQueryFactory
				.select(Projections.constructor(AdminResponseDto.class
						, admin.admin_id.as("adminId")
						, admin.name
	...
	// 정보 수정
	public void updateAdmin(DBRequestDto dto) {
	...
	public List<Tuple> findAdminDetailList(DBRequestDto dto) {
		return jpaQueryFactory
				.select(
	...
	public void deleteDBById(String string, String loginId) {
